...
本プロジェクトの独自成果物(BIOS・ローダ・SD作成ツール・エミュレータのハードウェア層・
ドキュメント等)は [MIT License](LICENSE) です。

CP/M 2.2 本体や利用する外部ツール・ライブラリ(The Macroassembler AS、kosarev/z80 等)は
それぞれのライセンスに従います。詳細は [doc/設計/11_ライセンス.md](doc/設計/11_ライセンス.md) を参照してください。
